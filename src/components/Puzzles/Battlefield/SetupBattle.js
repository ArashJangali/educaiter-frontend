...
function SetupBattle() {
  ...
  return (
    ...
    <button style={{background: 'transparent', border: 'none', boxShadow: 'none'}} onClick={() => navigate('/puzzles')}><img src='/icons/back.svg' style={{ width: '24px', height: '24px'}} alt="back icon"/></button>
      <h1>Battlefield</h1>
      </div>
    
      <img src="/icons/duel.svg" className="icon" alt="Battlefield" />
      ...
      <button
        ...
        onClick={() => {
          navigate("/battle", { state: { selectedAreas, selectedLevels } });
        }}
      >
        Custom
      </button>
